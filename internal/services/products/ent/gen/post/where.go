...
func Status(v schema.Status) predicate.Post {
	vc := string(v)
...
func StatusEQ(v schema.Status) predicate.Post {
	vc := string(v)
	return predicate.Post(sql.FieldEQ(FieldStatus, vc))
}

// StatusNEQ applies the NEQ predicate on the "status" field.
func StatusNEQ(v schema.Status) predicate.Post {
	vc := string(v)
	return predicate.Post(sql.FieldNEQ(FieldStatus, vc))
}

// StatusIn applies the In predicate on the "status" field.
func StatusIn(vs ...schema.Status) predicate.Post {
	v := make([]any, len(vs))
	for i := range v {
		v[i] = string(vs[i])
	}
...
func StatusNotIn(vs ...schema.Status) predicate.Post {
	v := make([]any, len(vs))
	for i := range v {
		v[i] = string(vs[i])
	}
...
func StatusGT(v schema.Status) predicate.Post {
	vc := string(v)
	return predicate.Post(sql.FieldGT(FieldStatus, vc))
}

// StatusGTE applies the GTE predicate on the "status" field.
func StatusGTE(v schema.Status) predicate.Post {
	vc := string(v)
	return predicate.Post(sql.FieldGTE(FieldStatus, vc))
}

// StatusLT applies the LT predicate on the "status" field.
func StatusLT(v schema.Status) predicate.Post {
	vc := string(v)
	return predicate.Post(sql.FieldLT(FieldStatus, vc))
}

// StatusLTE applies the LTE predicate on the "status" field.
func StatusLTE(v schema.Status) predicate.Post {
	vc := string(v)
	return predicate.Post(sql.FieldLTE(FieldStatus, vc))
}

// StatusContains applies the Contains predicate on the "status" field.
func StatusContains(v schema.Status) predicate.Post {
	vc := string(v)
	return predicate.Post(sql.FieldContains(FieldStatus, vc))
}

// StatusHasPrefix applies the HasPrefix predicate on the "status" field.
func StatusHasPrefix(v schema.Status) predicate.Post {
	vc := string(v)
	return predicate.Post(sql.FieldHasPrefix(FieldStatus, vc))
}

// StatusHasSuffix applies the HasSuffix predicate on the "status" field.
func StatusHasSuffix(v schema.Status) predicate.Post {
	vc := string(v)
	return predicate.Post(sql.FieldHasSuffix(FieldStatus, vc))
}

// StatusEqualFold applies the EqualFold predicate on the "status" field.
func StatusEqualFold(v schema.Status) predicate.Post {
	vc := string(v)
	return predicate.Post(sql.FieldEqualFold(FieldStatus, vc))
}

// StatusContainsFold applies the ContainsFold predicate on the "status" field.
func StatusContainsFold(v schema.Status) predicate.Post {
	vc := string(v)
	return predicate.Post(sql.FieldContainsFold(FieldStatus, vc))
}

// HasAuthors applies the HasEdge predicate on the "authors" edge.
func HasAuthors() predicate.Post {
...
func HasAuthorsWith(preds ...predicate.User) predicate.Post {
	return predicate.Post(func(s *sql.Selector) {
		step := newAuthorsStep()
...
// HasUserPosts applies the HasEdge predicate on the "user_posts" edge.
func HasUserPosts() predicate.Post {
	return predicate.Post(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasUserPostsWith applies the HasEdge predicate on the "user_posts" edge with a given conditions (other predicates).
func HasUserPostsWith(preds ...predicate.UserPost) predicate.Post {
	return predicate.Post(func(s *sql.Selector) {
...
func HasUserLikes() predicate.Post {
	return predicate.Post(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasUserLikesWith(preds ...predicate.UserLike) predicate.Post {
	return predicate.Post(func(s *sql.Selector) {
